...
# ==============================================================================
# 27 November 2016
# PURPOSE : This function extracts the features of both the file and each field/column
#           within it, and writes them to a "long" format data file. Because there is
#           this "long" structure, a the number of features that can be added is
#           limitless. There is a tagging structure which can be used to set attributes
#           about the attributes so they can be selectively consumed by other functions 
#           or programs. As the data created can be easily written to CSV, it is
#           not proprietry in any way.
#
# INPUT :   Required : an input dataset structured as a dataframe, table, ts, or filename
#           Optional : a title for the dataset
#
