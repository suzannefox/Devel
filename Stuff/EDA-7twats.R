...
setwd("C:/Users/Suzanne/OneDrive - Suzanne Fox/Work/the7stars")
getwd()
#install.packages("readr")
library(readr)
track <- read_csv("track_statistics.csv",col_names=TRUE)
tv <- read_csv("tvstats.csv",col_names=TRUE)
